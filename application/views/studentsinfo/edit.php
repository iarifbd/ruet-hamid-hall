        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <!-- Page title -->
                    <h1 class="text-center text-success mt-5 mb-3">Update Quotation Information:</h1>

                    <!-- Form starts here -->
                    <form action="<?= base_url('Quotetion/update') ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="quotation_number" id="quotation_number" class="form-control" value="<?php echo $QuteInfo['quotation_number']; ?>" readonly required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" name="qdate" id="qdate" class="form-control" value="<?php echo $QuteInfo['qdate']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" name="vdate" id="vdate" class="form-control" value="<?php echo $QuteInfo['vdate']; ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="Contact_Person" id="Contact_Person" class="form-control" value="<?php echo $QuteInfo['contact_person']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="Company_Name" id="Company_Name" class="form-control" value="<?php echo $QuteInfo['company_name']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address" id="address" class="form-control" value="<?php echo $QuteInfo['address']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="Contact" id="Contact" class="form-control" value="<?php echo $QuteInfo['contact']; ?>" required>
                                        </div>
                                    </div>
                                </div>
                            </div> 
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered" id="orderTable">
                                    ...
                                    <tbody>
                                        <?php foreach($QuteItemInfo as $key=> $value):; ?>
                                        <tr>
                                            <!-- Product Dropdown -->
                                            <td>
                                                <select name="product_id[]" class="form-control product_id selectpicker" data-live-search="true" data-width="100%" required>
                                                    ...
                                                    <option value="<?= $record['pid']; ?>" <?= ($record['pid'] == $value['product_id']) ? 'selected' : ''; ?> data-price="<?= $record['unitPrice'] ?>" data-stock="<?= $record['total_stock'] ?>">
                                            ...
                                            <td>
                                                <select name="measurement_id[]" class="form-control measurement_id selectpicker" data-live-search="true" data-width="100%" required>
                                                    ...
                                                    <option value="<?= $mea['id']; ?>" <?= ($mea['id'] == $value['measurement_id']) ? 'selected' : ''; ?>>
                                                        <?= $mea['unit_name']; ?>
                                                    </option>
                                            ...
                                            <!-- Unit Price Field -->
                                            <td>
                                                <input type="text" name="unit_price[]" class="form-control unit_price" value="<?php echo $value['unit_price']; ?>" readonly>
                                            </td>

                                            <!-- Quantity Field -->
                                            <td>
                                                <input type="number" name="order_quantity[]" class="form-control order_quantity" value="<?php echo $value['order_quantity']; ?>" required>
                                            </td>

                                            <!-- Sub-Total Field -->
                                            <td>
                                                <input type="text" name="sub_total[]" class="form-control sub_total" value="<?php echo $value['sub_total'];?>" readonly>
                                            </td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="grand_total" id="grand_total" class="form-control" value="<?php echo $QuteInfo['grand_total']; ?>"  readonly>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="net_total" id="net_total" class="form-control" value="<?php echo $QuteInfo['net_total']; ?>"  readonly>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table> 
                                ...
                                <select name="tc" id="tc" class="form-control electpicker" data-live-search="true" data-width="100%" required>
                                    ...
                                    <option value="<?php echo $QuteInfo['tc']; ?>" selected><?php echo $QuteInfo['tc']; ?></option>
                                    <?php foreach ($tc as $key => $tcv) { ?>
                                    <option value="<?= $tcv['content']; ?>" >
                                        <?= $tcv['content']; ?>
                                    </option>
                                    <?php } ;?>
                                </select>
                            ...
                            <div class="card-footer">
                                <!-- Add More Button -->
                                <button type="button" class="btn btn-primary" id="addRow"><i class="fa fa-refresh" aria-hidden="true"></i>Add More</button>
                                <!-- Save Quotation Button -->
                                <button type="submit" class="btn btn-success text-right"><i class="fa fa-save"></i> Update Quotation</button>
                            </div> 
                        </div>
