        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <!-- Page title -->
                    <h1 class="text-center text-success mt-5 mb-3">Create Invoice:</h1>

                    <!-- Form starts here -->
                    <form action="<?= base_url('Invoice/save') ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-end">
                                        <!-- Back to List Button -->
                                        <a href="<?php echo site_url('Invoice/list'); ?>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back to List</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="inv_number" id="inv_number" class="form-control" value="<?php echo $q = $this->lot_generator->generate_token(10); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" name="invdate" id="invdate" class="form-control" value="<?php echo date('Y-m-d\TH:i'); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <hr>
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" class="btn btn-success text-right"><i class="fa fa-save"></i> Save Invoice</button>
                            </div> 
                        </div>
                    </form>
                </div>
