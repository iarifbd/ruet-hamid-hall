        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <form action="<?= base_url('Store/save_product'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select name="product_id" id="product_id" class="form-control selectpicker" data-live-search="true" data-width="100%">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="lot_number" name="lot_number" value="<?php echo $lotNum;?>" required>
                                    </div>
                                </div>
