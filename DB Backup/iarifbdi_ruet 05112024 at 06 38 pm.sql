...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2024 at 01:38 PM
...
CREATE TABLE `charges` (
  `Id` int(11) NOT NULL,
  `Installation` decimal(10,2) DEFAULT NULL,
  `Firewood` decimal(10,2) DEFAULT NULL,
  `Electricity` decimal(10,2) DEFAULT NULL,
  `Welfare` decimal(10,2) DEFAULT NULL,
  `TV_and_Dis` decimal(10,2) DEFAULT NULL,
  `Filter` decimal(10,2) DEFAULT NULL,
  `Fine` decimal(10,2) DEFAULT NULL,
  `Common_Room` decimal(10,2) DEFAULT NULL,
  `Caution_Money` decimal(10,2) DEFAULT NULL,
  `Addmission` decimal(10,2) DEFAULT NULL,
  `Dish` decimal(10,2) DEFAULT NULL,
  `Mosque` decimal(10,2) DEFAULT NULL,
  `Library` decimal(10,2) DEFAULT NULL,
  `Literary_Parliament` decimal(10,2) DEFAULT NULL,
  `Student_Parliament` decimal(10,2) DEFAULT NULL,
  `Identity_Card` decimal(10,2) DEFAULT NULL,
  `Various` decimal(10,2) DEFAULT NULL,
...
INSERT INTO `hostel_floor` (`id`, `name`, `status`) VALUES
(1, '1', 'active'),
(2, '2', 'active'),
(3, '3', 'active'),
(4, '4', 'active');
...
INSERT INTO `hostel_room` (`id`, `name`, `status`) VALUES
(1, '104', 'active'),
(2, '105', 'active'),
(3, '106', 'active'),
(4, '107', 'active'),
...
--
-- Table structure for table `hostel_sit`
--

CREATE TABLE `hostel_sit` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `status` varchar(100) NOT NULL DEFAULT 'active'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Dumping data for table `hostel_sit`
--

INSERT INTO `hostel_sit` (`id`, `name`, `status`) VALUES
(1, '1', 'active'),
(2, '2', 'active'),
(3, '3', 'active'),
(4, '4', 'active');
...
(1, 'Abdul Hamid', '1', '104', '1', 20241, '2024-11-04', '0000-00-00', 'vacant'),
(2, 'Abdul Hamid', '2', '204', '2', 20242, '2024-11-04', '0000-00-00', 'occupy'),
(3, 'Abdul Hamid', '3', '104', '3', 0, '2024-11-04', '0000-00-00', 'vacant'),
(4, 'Abdul Hamid2', '2', '101', '2', 0, '2024-11-04', '0000-00-00', 'vacant'),
(5, 'Abdul Hamid', '3', '104', '3', 2345, '2024-11-05', '0000-00-00', 'occupy'),
(6, 'Abdul Hamid', '3', '104', '3', 2345, '2024-11-05', '0000-00-00', 'occupy');
...
(1, '2024-01-01', '2024-01-31', '0000-00-00', 20241, 'hall', 'Dr', 'HC', 500.00, 0.00, 500.00, 'Due'),
(2, '2024-01-01', '2024-01-31', '0000-00-00', 20242, 'hall', 'Dr', 'HC', 500.00, 0.00, 500.00, 'Due'),
(3, '2024-02-01', '2024-02-29', '0000-00-00', 20243, 'hall', 'Dr', 'HC', 500.00, 0.00, 500.00, 'Due'),
(27, '2024-04-13', '2024-04-30', '0000-00-00', 20241, 'Hall Charge on 2024-04-13', 'Dr', 'HC', 500.00, 0.00, 500.00, 'Due'),
(28, '2024-04-13', '2024-04-30', '0000-00-00', 20242, 'Hall Charge on 2024-04-13', 'Dr', 'HC', 500.00, 0.00, 500.00, 'Due'),
(29, '2024-04-13', '2024-04-30', '0000-00-00', 20242, 'Delay Fine on 2024-01-31 (for 3 Month): 15.00', 'Dr', 'DF', 15.00, 0.00, 15.00, 'Due'),
(30, '2024-04-13', '2024-04-30', '0000-00-00', 20243, 'Delay Fine on 2024-02-29 (for 2 Month): 10.00', 'Dr', 'DF', 10.00, 0.00, 10.00, 'Due'),
(31, '2024-11-05', '2024-11-30', '0000-00-00', 2345, 'Hall Charge on 2024-11-05', 'Dr', 'HC', 500.00, 0.00, 500.00, 'Due'),
(32, '2024-11-05', '2024-11-30', '0000-00-00', 20242, 'Hall Charge on 2024-11-05', 'Dr', 'HC', 500.00, 0.00, 500.00, 'Due'),
(33, '2024-11-05', '2024-11-30', '0000-00-00', 2345, 'Hall Charge on 2024-11-05', 'Dr', 'HC', 500.00, 0.00, 500.00, 'Due'),
(34, '2024-11-05', '2024-11-30', '0000-00-00', 2345, 'Hall Charge on 2024-11-05', 'Dr', 'HC', 500.00, 0.00, 500.00, 'Due'),
(35, '2024-11-05', '2024-11-30', '0000-00-00', 20241, 'Delay Fine on 2024-01-31 (for 10 Month): 50.00', 'Dr', 'DF', 50.00, 0.00, 50.00, 'Due'),
(36, '2024-11-05', '2024-11-30', '0000-00-00', 20242, 'Delay Fine on 2024-01-31 (for 10 Month): 50.00', 'Dr', 'DF', 50.00, 0.00, 50.00, 'Due'),
(37, '2024-11-05', '2024-11-30', '0000-00-00', 20243, 'Delay Fine on 2024-02-29 (for 9 Month): 45.00', 'Dr', 'DF', 45.00, 0.00, 45.00, 'Due'),
(38, '2024-11-05', '2024-11-30', '0000-00-00', 20241, 'Delay Fine on 2024-04-30 (for 7 Month): 35.00', 'Dr', 'DF', 35.00, 0.00, 35.00, 'Due'),
(39, '2024-11-05', '2024-11-30', '0000-00-00', 20242, 'Delay Fine on 2024-04-30 (for 7 Month): 35.00', 'Dr', 'DF', 35.00, 0.00, 35.00, 'Due'),
(40, '2024-11-05', '2024-11-30', '0000-00-00', 20242, 'Hall Charge on 2024-11-05', 'Dr', 'HC', 500.00, 0.00, 500.00, 'Due'),
(41, '2024-11-05', '2024-11-30', '0000-00-00', 2345, 'Hall Charge on 2024-11-05', 'Dr', 'HC', 500.00, 0.00, 500.00, 'Due'),
(42, '2024-11-05', '2024-11-30', '0000-00-00', 2345, 'Hall Charge on 2024-11-05', 'Dr', 'HC', 500.00, 0.00, 500.00, 'Due'),
(43, '2024-11-05', '2024-11-30', '0000-00-00', 20241, 'Delay Fine on 2024-01-31 (for 10 Month): 50.00', 'Dr', 'DF', 50.00, 0.00, 50.00, 'Due'),
(44, '2024-11-05', '2024-11-30', '0000-00-00', 20242, 'Delay Fine on 2024-01-31 (for 10 Month): 50.00', 'Dr', 'DF', 50.00, 0.00, 50.00, 'Due'),
(45, '2024-11-05', '2024-11-30', '0000-00-00', 20243, 'Delay Fine on 2024-02-29 (for 9 Month): 45.00', 'Dr', 'DF', 45.00, 0.00, 45.00, 'Due'),
(46, '2024-11-05', '2024-11-30', '0000-00-00', 20241, 'Delay Fine on 2024-04-30 (for 7 Month): 35.00', 'Dr', 'DF', 35.00, 0.00, 35.00, 'Due'),
(47, '2024-11-05', '2024-11-30', '0000-00-00', 20242, 'Delay Fine on 2024-04-30 (for 7 Month): 35.00', 'Dr', 'DF', 35.00, 0.00, 35.00, 'Due');
...
--
-- Indexes for table `hostel_floor`
--
...
--
-- Indexes for table `hostel_sit`
--
ALTER TABLE `hostel_sit`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `hostel_floor`
--
ALTER TABLE `hostel_floor`
...
--
-- AUTO_INCREMENT for table `hostel_sit`
--
ALTER TABLE `hostel_sit`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
